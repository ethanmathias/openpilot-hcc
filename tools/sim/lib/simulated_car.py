...
class SimulatedCar:
  ...
  def send_can_messages(self, simulator_state: SimulatorState):
    ...
    msg.append(self.packer.make_can_msg("CRUISE_FAULT_STATUS", 0, {"COUNTER": counter}))
    ...
    msg.append(self.packer.make_can_msg("CAR_SPEED", 0, {"COUNTER": counter}))

    # *** cam bus ***
    msg.append(self.packer.make_can_msg("STEERING_CONTROL", 2, {}))
    msg.append(self.packer.make_can_msg("ACC_HUD", 2, {"COUNTER": counter}))
    msg.append(self.packer.make_can_msg("LKAS_HUD", 2, {"COUNTER": counter}))
