...
class MetaDriveBridge(SimulatorBridge):
  ...
  def __init__(self, dual_camera, high_quality, test_duration=math.inf, test_run=False, enable_hcc=False):
  ...
  def spawn_world(self, queue: Queue):
    ...
    config = dict(
      ...
      lead_speed_ramp_sec=90,
      lead_vehicle_lateral_offset=0.0,
      lead_vehicle_model="s",
      lead_vehicle_render=True,
      lead_vehicle_expert_policy=True,
      lead_vehicle_expert_min_speed_mph=8.0,
