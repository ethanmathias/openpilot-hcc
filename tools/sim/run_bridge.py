...
def create_bridge(dual_camera, high_quality, scenario):
  queue: Any = Queue()
...
def main():
  _, simulator_process, _ = create_bridge(True, False, "default")
...
if __name__ == "__main__":
  ...
  queue, simulator_process, simulator_bridge = create_bridge(args.dual_camera, args.high_quality, args.scenario)
