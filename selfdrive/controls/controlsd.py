...
class Controls:
  ...
  def publish(self, CC, lac_log):
    ...
    # In simulator replay mode these fields carry planner/HC3/manual accel
    # contributions instead of PID internals so the bridge can write richer
    # telemetry without adding new cereal schema.
